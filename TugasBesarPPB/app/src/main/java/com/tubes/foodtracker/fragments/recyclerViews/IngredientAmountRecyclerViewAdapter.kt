package com.tubes.foodtracker.fragments.recyclerViews
...
import com.tubes.foodtracker.data.InvalidIngredientAmount
import com.tubes.foodtracker.data.ValidIngredientAmount
import com.tubes.foodtracker.data.UnitHelper
import com.tubes.foodtracker.databinding.FragmentIngredientamountBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (item){
            is ValidIngredientAmount -> {
                ...
                holder.calorieView.text = UnitHelper.displayUnit(com.tubes.foodtracker.data.Unit.Calorie,item.intakeValues.Calories)
            }
